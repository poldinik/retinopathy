...
results_path = "/Users/loretto/Desktop/output/results"
...
data_path = "/Users/loretto/Desktop/output/dataset"
...
df = pd.DataFrame(list(parameters.items()), columns=["coehn", "acc"])
